...
#ifdef ADC12_IIR_DISABLED
  ret = ((uint16_t) (adc12_dma_buffer[ch]*ADC12_GetVref()/ADC12_MAX_VALUE));
#else
  ret = ((uint16_t) (adc12_output_buffer[ch]*ADC12_GetVref()/ADC12_MAX_VALUE));
#endif
